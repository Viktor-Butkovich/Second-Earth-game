...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Post-modern}: nanomaterials, superconductors, etc. - modern research grade but not feasible at scale, likely allowing fusion, quantum computing, etc. if they became widely available
    ...
    \begin{itemize}
        \item \textbf{Metallic building materials}: Used for structural support and machinery
        \begin{enumerate}
            ...
            \item Future materials - likely only theoretical or unconsidered at this point.
        \end{enumerate}
        \item \textbf{Nonmetallic building materials}: Non-metals used as structural base 
        \begin{enumerate}
            ...
            \item Future materials - likely only theoretical or unconsidered at this point.
        \end{enumerate}
        \item \textbf{Advanced metals}: Used for specialized properties like unusual conductivity, corrosion or heat resistance, etc.
        \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Future materials - likely only theoretical or unconsidered at this point.
        \end{enumerate}
        \item \textbf{Chemicals}: Process reagents and products for manufacturing and other processes. Includes a wide variety of
